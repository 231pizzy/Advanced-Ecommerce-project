...
export default function PlaceOrderPage() {
  ...
  cart.shippingPrice = cart.shippingAddress.price;
  cart.taxPrice = Math.round(0.01 * cart.itemsPrice * 100) / 100;
  ...
  const placeOrderHandler = async () => {
    try {
      const data = await createOrder({
        ...
        shippingPrice: cart.shippingAddress.price,
          ...
          <Card className="mb-3">
            <Card.Body>
              ...
              <Card.Text>
                ...
                <br />
                <strong>Shipping Fee </strong> {cart.shippingAddress.price}
              </Card.Text>
