                ...
                {order.orderItems.map((item) => (
                  <ListGroup.Item key={item._id}>
                    <Row className="align-items-center">
                      ...
                      <Col md={3}>₦{item.price.toLocaleString("en-Us")}</Col>
                    </Row>
                  </ListGroup.Item>
                ))}
              </ListGroup>
          ...
          <Card className="mb-3">
            <Card.Body>
              ...
              <ListGroup variant="flush">
                ...
                {/* BANK PAYMENT */}
                {order.paymentMethod === "Bank" && !order.isPaid && (
                  <ListGroup.Item>
                    ...
                    {/* Account details based on bank selection */}
                    <div>
                      {bankSelected === "firstBank" && (
                        <div>
                          <p>Account Number: 3092266613</p>
                          <p>Account Name: Obiora Kingsley Ejiofor</p>
                        </div>
                      )}
                      {bankSelected === "sterlingBank" && (
                        <div>
                          <p>Account Number: 0074132349</p>
                          <p>Account Name: Obiora Ejiofor Kingsley</p>
                        </div>
                      )}
                      {/* Add details for other banks here */}
                    </div>
